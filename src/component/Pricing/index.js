                    ...
                    <div className="
                      ...
                      <span className="
														...
														">$</span><span className="
															...
															h1
															pricing-switchable
														" data-pricing-monthly={34} data-pricing-yearly={27}>27</span>
                    </div>
                    <div className="
                    ...
                    <div className="
                      ...
                      <span className="
														...
														">$</span><span className="
															...
															h1
															pricing-switchable
														" data-pricing-monthly={54} data-pricing-yearly={47}>47</span>
                    </div>
                    <div className="
														text-xs text-color-low
													">
                    ...
                    <div className="
                      ...
                      <span className="
														...
														">$</span><span className="
															...
															h1
															pricing-switchable
														" data-pricing-monthly={74} data-pricing-yearly={67}>67</span>
                    </div>
                    <div className="
														text-xs text-color-low
													">
